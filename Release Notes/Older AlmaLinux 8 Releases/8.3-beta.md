...
The release code name: Purple [Manul](https://en.wikipedia.org/wiki/Pallas's_cat).
...
:::warning Use this version to thoroughly test your workloads and report any unintended features (ie, bugs) you may find, it will help make AlmaLinux better. :::
