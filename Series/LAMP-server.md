...
*   **Manipulate your hosts file to view your newly created website:**
    ...
    ::: tip While I cant tell you your **IP** address, I can tell you that the domain is almasite.com and the alias is www.almasite.com. (That is if you followed my guide exactly)
...
*   **Results:**
    ...
    You should get a similar result: ![LAMP-server-results](../images/HowTo-LAMP-server-2.png)
